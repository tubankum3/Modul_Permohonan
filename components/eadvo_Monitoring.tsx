...
const Monitoring: React.FC<MonitoringProps> = ({ currentView, onNavigate }) => {
    ...
    const menus = isPencarianView ? [
        ...
        { group: 'MONITORING', items: [
            ...
            { icon: <TrendingUpIcon className="h-4 w-4" />, name: 'Statistik Perkara', view: 'eAdvokasiStatistikPerkara' as View },
                ...
                <div className="flex justify-between items-end bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div className="flex space-x-3">
                        ...
                        <div className="border-l border-gray-200 pl-3 flex items-center">
                            <button className="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition shadow-sm">
                                <DownloadIcon className="h-4 w-4" />
