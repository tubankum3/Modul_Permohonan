            ...
            {modal.isOpen && (
                <CrudModal isOpen={modal.isOpen} onClose={() => setModal({ type: '', isOpen: false, data: null })} onSave={handleCrudSave}
                    ...
                    fields={
                        ...
                        : modal.type === 'putusan' ? [ 
                            { name: 'posisi', label: 'Tingkat', type: 'select', options: ['Pertama', 'Banding', 'Kasasi', 'PK'] },
                            ...
                            { name: 'status', label: 'Status', type: 'select', options: ['Menang', 'Kalah', 'Damai'] },
                            { name: 'dokumen', label: 'Dokumen Putusan (PDF/DOCX)', type: 'file' }
                        ]
                        : []
                    }
