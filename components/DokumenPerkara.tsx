...
import { ArrowLeftIcon, DownloadIcon, EyeIcon, SearchIcon, CloudArrowDownIcon, PencilSquareIcon, DocumentTextIcon } from './icons';
  ...
  return (
    <div className="p-8 bg-gray-50 h-full overflow-y-auto">
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        {/* 2. Dokumen Litigasi */}
        {renderTable(
          "2. Dokumen Litigasi (SKU, Dokumen Litigasi)",
