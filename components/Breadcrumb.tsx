...
const viewLabels: Record<string, { label: string; parent?: View }> = {
    ...
    'eAdvokasiTelaahanKasusHukum': { label: 'Telaahan Kasus Hukum' },
    'eAdvokasiTelaahanDetail': { label: 'Detail Telaahan', parent: 'eAdvokasiTelaahanKasusHukum' },
    'eAdvokasiTelaahanDokumen': { label: 'Dokumen Telaahan', parent: 'eAdvokasiTelaahanKasusHukum' },
    'eAdvokasiTelaahanTim': { label: 'Tim Advokasi', parent: 'eAdvokasiTelaahanKasusHukum' },
    ...
    'eAdvokasiTim': { label: 'Pengelolaan Tim' },
    'eAdvokasiUser': { label: 'Manajemen Pengguna' },
    'eAdvokasiProses': { label: 'Proses Permohonan', parent: 'eAdvokasiInbox' },
    ...
    'eAdvokasiStatistikPerkara': { label: 'Statistik Perkara', parent: 'eAdvokasiMonitoring' },
    ...
    'eAdvokasiPencarianDokumen': { label: 'Dokumen', parent: 'eAdvokasiPencarian' as View },
